...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [_LOWER] = LAYOUT( \
      KC_BSPC, KC_0,    KC_9,    KC_8,    KC_7,    KC_6,                      KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_BSPC, \
      ...
      _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_ESC,  KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY \
      ),
   ...
   */
  [_RAISE] = LAYOUT( \
      KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      KC_5,    KC_4,    KC_3,    KC_2,    KC_1,    KC_GRV,  \
      ...
      _______, _______, _______, _______, KC_ESC,  _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY \
      ),
